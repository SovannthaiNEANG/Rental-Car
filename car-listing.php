...
$query = "SELECT count(*) as cntVehicle from tblvehicles";
...
?>
<p><span><?php echo $cnt;?> Listings</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">$<?php echo $result['PricePerDay'];?> Per Day</p>
            <ul>
            ...
            <a href="vehical-details.php?vhid=<?php echo $result['id'];?>" class="btn">View Details <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php } ?>
         </div>
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php $query = "SELECT tblvehicles.*, tblbrands.BrandName, tblbrands.id as bid  
                from tblvehicles 
                join tblbrands 
                on tblbrands.id = tblvehicles.VehiclesBrand 
