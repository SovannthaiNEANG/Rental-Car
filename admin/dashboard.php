...
<?php 
	$query = "SELECT count(id) as cnt from tblusers";
	$result = mysqli_query($conn, $query);
	$row = mysqli_fetch_array($result);
?>
													<div class="stat-panel-number h1 "><?php echo $row['cnt'];?></div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<?php 
	$query = "SELECT count(id) as cnt from tblvehicles";
	$result = mysqli_query($conn, $query);
	$row = mysqli_fetch_array($result);
?>
													<div class="stat-panel-number h1 "><?php echo $row['cnt'];?></div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
	$query ="SELECT count(id) as cnt from tblbooking";
	$result = mysqli_query($conn, $query);
	$row = mysqli_fetch_array($result);
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
<?php 
	$query = "SELECT count(id) as cnt from tblbrands";
	$result = mysqli_query($conn, $query);
	$row = mysqli_fetch_array($result);
?>												
													<div class="stat-panel-number h1 "><?php echo $row['cnt'];?></div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
<?php 
$query = "SELECT count(id) as cnt from tblsubscribers";
$result = mysqli_query($conn, $query);
$row = mysqli_fetch_array($result);
?>
													<div class="stat-panel-number h1 "><?php echo $row['cnt'];?></div>
													<div class="stat-panel-title text-uppercase">Subscribes</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<?php 
	$query = "SELECT count(id) as cnt from tblcontactusquery";
	$result = mysqli_query($conn, $query);
	$row = mysqli_fetch_array($result);
?>
													<div class="stat-panel-number h1 "><?php echo $row['cnt'];?></div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php 
	$query = "SELECT count(id) as cnt from tbltestimonial";
	$result = mysqli_query($conn, $query);
	$row = mysqli_fetch_array($result);
?>
